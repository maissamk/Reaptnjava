...
public class IndexMaterielController {
    ...
    private final int currentUserId = SessionManager.getInstance().getCurrentUser().getId(); // Default to 2 for testing, replace with actual user ID
    ...
    private void handleShowVente(MaterielVente materiel) {
        try {
            ...
            controller.setCurrentUserId(currentUserId); // Pass the actual user ID
