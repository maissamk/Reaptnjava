...
public class IndexCategorieController {
    ...
    private void showAddForm() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/category/AddCategorie.fxml"));
    ...
    private void showCategorieDetails(Categorie categorie) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/category/ShowCategorie.fxml"));
            Parent root = loader.load();
    ...
    private void showEditForm(Categorie categorie) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/category/EditCategorie.fxml"));
            Parent root = loader.load();
    ...
    void gotomaterials(ActionEvent event) {
        try {
            ...
            // Load new window
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/materials/IndexMateriel.fxml"));
            Parent root = loader.load();
