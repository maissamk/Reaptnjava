...
public class PDFGenerator {
    ...
    private static void addVenteDetails(Document document, MaterielVente materiel) throws DocumentException {
        ...
        addDetailRow(table, "Created At", materiel.getCreatedAt().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME));
        addDetailRow(table, "Last Updated", materiel.getUpdatedAt().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME));
